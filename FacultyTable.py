...
# NOTES:
#
#   Faculty Table Implementation
#     Each faculty is assigned a 2D list which represents a table as follows:
#     Faculty: Dr. Mike
#     -------------------------------
#             |  MW (0)  |  TR (1)  |
#     -------------------------------
...
class FacultyTable:
    """
    Data structure to organize time periods for every teacher
    """
